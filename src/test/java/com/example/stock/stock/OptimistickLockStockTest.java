...
import com.example.stock.facade.OptimistickLockStockFacade;
...
@SpringBootTest
public class OptimistickLockStockTest {
    @Autowired
    OptimistickLockStockFacade stockService;
    @Autowired
    ...
    @Test
    public void 감소테스트() throws InterruptedException {
        // given
